...
describe PuppetForge::Metadata do
        ...
        it 'raises an exception' do
          expect do
            subject
                             ...
                             "Invalid 'name' field in metadata.json: the namespace contains non-alphanumeric characters")
        end
      end
        ...
        it 'raises an exception' do
          expect do
            subject
                             ...
                             "Invalid 'name' field in metadata.json: the module name contains non-alphanumeric (or underscore) characters")
        end
      end
        ...
        it 'raises an exception' do
          expect do
            subject
                             ...
                             "Invalid 'name' field in metadata.json: the module name must begin with a letter")
        end
      end
    end
    ...
    context 'with a valid source' do
      ...
      context 'which is not a GitHub URL' do
        ...
        it 'does not predict a default project_page' do
          expect(subject.to_hash['project_page']).to be_nil
        end

        it 'does not predict a default issues_url' do
          expect(subject.to_hash['issues_url']).to be_nil
        end
      end
  ...
  describe '#to_hash' do
    ...
    it 'contains the default set of keys' do
      expect(subject.keys.sort).to eq(%w[name version author summary license source issues_url project_page
                                         dependencies].sort)
    end
